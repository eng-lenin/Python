...
def resumo(preço=0, taxa=5):
    ...
    print(f'Aumentando o preço {moeda(preço)} em {taxa:.2f}% temos: \t{aumentar(preço, taxa, True)}')
    print(f'Diminuindo o preço {moeda(preço)} em {taxa:.2f}% temos: \t{diminuir(preço, taxa, True)}')